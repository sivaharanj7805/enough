...
Build the complete Next.js frontend for Tended. This is the product users see — the landscape visualization, cannibalization map, Oracle, and health dashboard.
