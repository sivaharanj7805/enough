...
| 5 | `redirect_push.py:98-111` | WordPress fallback endpoint `/wp/v2/settings` with `enough_redirect` key doesn't exist — fails silently | Redirects never pushed if Redirection plugin missing |
