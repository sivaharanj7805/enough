...
export const metadata = {
  title: 'Terms of Service — Enough',
  description: 'Terms of Service for Enough Content Ecosystem Intelligence Platform',
};
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1a] text-[#e2e8f0]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        {[
          { title: '1. Acceptance of Terms', body: 'By accessing or using Enough ("the Service"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Service.' },
          { title: '2. Description of Service', body: 'Enough is a content intelligence platform that analyses publicly accessible blog content and provides recommendations to improve content performance. The Service is read-only — it does not modify, publish, or delete any content on your website.' },
          ...
          { title: '8. Intellectual Property', body: 'The Service, including all software, algorithms, and content, is owned by Enough. Your content remains yours — we claim no ownership over content we analyse.' },
          ...
          { title: '10. Limitation of Liability', body: 'To the maximum extent permitted by law, Enough shall not be liable for any indirect, incidental, or consequential damages arising from your use of the Service.' },
          ...
          { title: '12. Contact', body: 'For questions about these terms, contact us at legal@enough.app' },
        ].map(({ title, body }) => (
