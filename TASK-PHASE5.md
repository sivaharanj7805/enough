...
- Hero section:
  ...
  - Subheadline: "Every content tool tells you to create more. Enough is the only one that tells you when more is less."
...
# Email (Resend)
RESEND_API_KEY=
EMAIL_FROM=Enough <reports@enough.app>
```
...
4. Run: openclaw system event --text "Done: Phase 5 complete — weekly ecosystem reports, impact tracking with shareable cards, steward profile, Stripe billing, marketing landing page. ENOUGH IS SHIP-READY." --mode now
